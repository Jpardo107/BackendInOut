"""
Django settings for backend_inout project.
...
SECRET_KEY = 'django-insecure-z(478=$*i9-!tf(ef^5=4gohpefs9t&+7gl0=a)3wh=81&_m3p'
...
DATABASES = {
    'default': dj_database_url.config(
        default=os.getenv('DATABASE_URL')  # Render generará automáticamente esta variable
    )
}
...
SWAGGER_SETTINGS = {
    'SECURITY_DEFINITIONS': {
        'Bearer': {
            ...
            'name': 'Authorization',
            'in': 'header',
            'description': 'Coloca tu token aquí: Bearer <access_token>'
        }
    }
}
# settings.py
